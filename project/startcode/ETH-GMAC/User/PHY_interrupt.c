...
#ifdef USE_ETH_PHY_INTERRUPT /* 如果定义了使用物理层中断 */

globe_eth_status_t globe_eth_status; /* 全局以太网状态 */

/*******************************************************************************
* Function Name  : phy_int_cheak_init
* Description    : Initializes the GPIO interrupt(PB15).
* Input          : None
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : cheak_phy_int
* Description    : cheak phy interrupt.
* Input          : None
* Return         : None
*******************************************************************************/
