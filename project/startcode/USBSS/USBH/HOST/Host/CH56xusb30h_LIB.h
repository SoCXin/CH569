...
/**** ******************************************************************************
* Function Name  : USB30H_Send_Setup
* Description    : 发送SETUP包
* Input          : SETUP包长度
* Return         : None
  **********************************************************************************/
...
/**** ******************************************************************************
* Function Name  : USB30H_Send_Status
* Description    : 控制传输状态阶段状态包
* Input          : tx_len：发送长度
* Return         : None
  **********************************************************************************/
...
/**** ******************************************************************************
* Function Name  : USB30H_Erdy_Status
* Description    : 控制传输状态阶段状态包
* Input          : nump：返回设备准备传输包数量
*                  endp：数据传输准备完成端点号
* Return         :  1：收到ERDY
*                   0：未收到ERDY
  **********************************************************************************/
...
/**** ******************************************************************************
* Function Name  : USB30H_IN_Data
* Description    : 从设备端点获取数据
* Input          : seq_num：包序列
*                  packet_num ：包数量,返回剩余未传输包数量
*                  endp_num：端点号
* Return         : bit0~15定义：
*                       bit15:EOB/LPF标志
...
/**** ******************************************************************************
* Function Name  : USB30H_OUT_Data
* Description    : 向设备端点发送数据
* Input          : seq_num：包序列
*                  packet_num ：包数量
*                  endp_num：端点号
*                  tx_len：包长度
...
/**** ******************************************************************************
* Function Name  : USB30H_Set_Address
* Description    : 设置主机发送的目标地址
* Input          : address：地址
* Return         : None
  **********************************************************************************/
...
/**** ******************************************************************************
* Function Name  : USB30H_Switch_Powermode
* Description    : 切换USBSS电源模式
* Input          : pwr_mode：电源模式
* Return         : None
  **********************************************************************************/
